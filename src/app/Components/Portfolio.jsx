...
const portfolioImageClass = 'rounded-lg shadow-md shadow-gray-600 object-cover transition duration-100 ease-in-out hover:scale-105 dark:shadow-lg dark:shadow-gray-950'
