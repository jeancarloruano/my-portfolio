...
const projectModalClass = 'bg-gray-200 flex flex-col items-center justify-center justify-between w-[70vw] h-[60vh] sm:w-[50vw] max-w-lg max-h-screen-md m-10 shadow-md shadow-gray-600 p-10 rounded-xl dark:bg-gray-700 dark:shadow-lg dark:shadow-gray-950'
const imageContainerClass = 'relative w-40 h-40 sm:w-60 sm:h-60 drop-shadow-xl'
...
function ProjectModal({onClose}) {
    console.log(typeof onClose); // This should log 'function'
