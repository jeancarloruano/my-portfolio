...
const ScrollToTopButton = () => {
    ...
    const scrollToTopButtonClass = "flex items-center justify-center w-10 h-10 rounded-full cursor-pointer text-5xl text-gray-600 shadow-md shadow-gray-600 dark:text-gray-400 dark:shadow-lg dark:shadow-gray-950"
