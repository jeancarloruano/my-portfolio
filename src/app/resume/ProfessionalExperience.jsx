export default function ProfessionalExperience() {
    return (
        <div id='professional-experience-section'>
            <h3 id='professional-experience-title' className='resume-details-h3'>Professional Experience</h3>
                <div id='sqasquared-details' className='resume-details-container'>
                    <div id='sqasquared-details-title' className='resume-details-header'>
                        ...
                        <span className='resume-details-header-title'>Jul. 2021 – Present</span>
                    </div>
                    <div id='sqasquared-details-subtitle' className='resume-details-header'>
                    ...
                    <ul id='sqasquared-details-list' className='resume-details-list'>
                ...
                <div id='altruist-details' className='resume-details-container'>
