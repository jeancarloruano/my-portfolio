export default function Internship() {
    return (
        <div id='internship-section'>
            <h3 id='internship-title' className='resume-details-h3'>Internship</h3>
                <div id='internship-details' className='resume-details-container'>
                    <div id='internship-details-title' className='resume-details-header'>
                        ...
                        <span className='resume-details-header-title'>Spring 2021</span>
                    </div>
                    <div id='internship-details-subtitle' className='resume-details-header'>
                    ...
                    <ul id='internship-details-list' className='resume-details-list'>
