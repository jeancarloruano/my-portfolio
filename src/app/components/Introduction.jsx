...
const logoContainerClass = 'flex justify-center gap-10 md:gap-16 py-3 text-gray-600 text-4xl md:text-5xl dark:text-gray-400'
const logoClass = 'transition duration-100 ease-in-out hover:text-cyan-500 hover:scale-105'
const imageContainerClass = 'relative mx-auto bg-gradient-to-r from-cyan-500 to-teal-500 rounded-full w-60 h-60 sm:w-80 sm:h-80 mt-20 overflow-hidden md:h-96 md:w-96 border-gray-600 border-4 shadow-md shadow-gray-600 dark:border-gray-400 dark:shadow-lg dark:shadow-gray-950'
