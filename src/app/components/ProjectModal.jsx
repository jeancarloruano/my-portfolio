...
const projectModalClass = 'bg-gray-200 flex flex-col items-center justify-center justify-between w-[70vw] h-[50vh] sm:w-[50vw] md:h-[60vh] max-w-2xl max-h-screen-md m-10 border-8 border-gray-600 shadow-md shadow-gray-600 p-10 rounded-xl dark:bg-gray-700 dark:border-gray-400 dark:shadow-lg dark:shadow-gray-950'
