...
const h3Class = 'text-2xl pt-2 md:text-3xl dark:text-white'
const inputClass = 'bg-gray-200 appearance-none border-none rounded-lg w-full py-2 px-4 text-gray-800 leading-tight shadow-inner-light dark:shadow-inner-dark focus:outline-none focus:bg-white focus:border-cyan-500 dark:bg-gray-600 dark:border-gray-600 mb-4'
const textareaClass = 'bg-gray-200 appearance-none border-none rounded-lg w-full resize-none py-2 px-4 text-gray-800 leading-tight shadow-inner-light dark:shadow-inner-dark focus:outline-none focus:bg-white focus:border-cyan-500 dark:bg-gray-600 dark:border-gray-600 mb-4'
const imageContainerClass = 'relative flex justify-center items-center w-52 h-52 sm:w-60 sm:h-60 md:w-80 md:h-80 mx-auto mb-4 drop-shadow-lg'
